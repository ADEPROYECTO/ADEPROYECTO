...
//CREAR LISTASS
pTitulo.textContent = 'Magdalenas de limón';
const ingredientesMagdalenasLimon = ['2 Tazas de harina', '1 Taza de azúcar', '1/2 Taza de mantequilla', '2 Huevos', '1/2 Taza de leche', 'Ralladura de 1 limón', 'Jugo de 1 limón', '2 Cucharaditas de polvo de hornear', '1 Pizca de sal'];
ingredientesMagdalenasLimon.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Precalienta el horno a 180°C. En un tazón grande, bate la mantequilla con el azúcar hasta que esté cremosa. Añade los huevos, uno a uno, y mezcla bien. Añade la ralladura y el jugo de limón. En otro tazón, mezcla la harina, el polvo de hornear y la sal. Añade los ingredientes secos a la mezcla de mantequilla, alternando con la leche. Vierte la masa en moldes para magdalenas y hornea durante 20-25 minutos o hasta que estén doradas y al insertar un palillo, este salga limpio.";
imgReceta.src = 'magdalenas.jpg';
imgReceta.alt = 'magdalenas de limón';
