...
//CREAR LISTASS
pTitulo.textContent = 'Pollo a la plancha con limón';
const ingredientesPolloLimon = ['2 Pechugas de pollo', '2 Limones', '2 Dientes de ajo', 'Aceite de oliva', 'Sal', 'Pimienta', 'Perejil fresco (opcional)'];
ingredientesPolloLimon.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Sazona las pechugas de pollo con sal y pimienta. En un tazón, mezcla el jugo de los limones, los dientes de ajo picados y un poco de aceite de oliva. Marina el pollo en esta mezcla durante al menos 30 minutos. Calienta una sartén o plancha y cocina el pollo hasta que esté dorado y bien cocido. Sirve con perejil fresco picado si lo deseas.";
imgReceta.src = 'polloLimon.jpg';
imgReceta.alt = 'pollo a la plancha con limón';
