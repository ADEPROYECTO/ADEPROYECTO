...
//CREAR LISTASS
pTitulo.textContent = 'Caldo de verduras';
const ingredientesCaldoVerduras = ['2 Zanahorias', '2 Papas', '1/2 Cebolla', '2 Ramas de apio', '1 Calabacín', '1 Tomate', 'Sal', 'Pimienta', 'Agua'];
ingredientesCaldoVerduras.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Lava y corta todas las verduras en trozos grandes. En una olla grande, añade agua y todas las verduras. Cocina a fuego medio hasta que todas las verduras estén tiernas. Añade sal y pimienta al gusto.";
imgReceta.src = 'caldoVerduras.jpg';
imgReceta.alt = 'caldo de verduras';
