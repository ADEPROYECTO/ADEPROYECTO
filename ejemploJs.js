...
//CREAR LISTASS
pTitulo.textContent = 'titulo receta';
const ingredientes = ['ingrediente', 'ingrediente', 'ingrediente'];
...
//PROCEDIMIENTOO
pProcedimiento.textContent = 'Instrucciones';
imgReceta.src = 'IMAGENDSURECETA.jpg';
