...
//CREAR LISTASS
pTitulo.textContent = 'Caldo de pollo';
const ingredientesCaldoPollo = ['1 Pollo entero', '2 Zanahorias', '2 Papas', '1/2 Cebolla', '2 Ramas de apio', 'Sal', 'Pimienta', 'Agua'];
ingredientesCaldoPollo.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Lava y corta las verduras en trozos grandes. En una olla grande, coloca el pollo y añade suficiente agua para cubrirlo. Agrega las verduras, sal y pimienta al gusto. Cocina a fuego medio hasta que el pollo esté bien cocido y las verduras tiernas. Retira el pollo, desmenúzalo y vuelve a agregarlo al caldo.";
imgReceta.src = 'caldoPollo.jpg';
imgReceta.alt = 'caldo de pollo';
