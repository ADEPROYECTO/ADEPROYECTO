...
//CREAR LISTASS
pTitulo.textContent = 'Sandwich de pollo';
const ingredientesSandwichPollo = ['Pan de sándwich', 'Pechuga de pollo cocida y desmenuzada', 'Mayonesa', 'Lechuga', 'Tomate'];
ingredientesSandwichPollo.forEach(ingrediente => {
