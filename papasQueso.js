...
//CREAR LISTASS
pTitulo.textContent = 'Papas con queso al horno';
const ingredientesPapasQueso = ['4 Papas', '1 Taza de queso rallado', '1/2 Taza de crema', 'Sal', 'Pimienta'];
ingredientesPapasQueso.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Precalienta el horno a 180°C. Lava y corta las papas en rodajas finas. Coloca las rodajas en una bandeja para hornear y sazona con sal y pimienta. Cubre con la crema y el queso rallado. Hornea durante 25-30 minutos o hasta que las papas estén tiernas y el queso dorado.";
imgReceta.src = 'papasQueso.jpg';
imgReceta.alt = 'papas con queso al horno';
