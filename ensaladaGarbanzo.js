...
//CREAR LISTASS
pTitulo.textContent = 'Ensalada de garbanzo';
const ingredientesEnsaladaGarbanzo = ['1 Lata de garbanzos cocidos', '1 Tomate', '1 Pepino', '1/2 Cebolla', '2 Cucharadas de aceite de oliva', 'Jugo de 1 limón', 'Sal', 'Pimienta', 'Perejil fresco (opcional)'];
ingredientesEnsaladaGarbanzo.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Escurre y enjuaga los garbanzos. Corta el tomate, el pepino y la cebolla en cubos pequeños. En un tazón grande, mezcla los garbanzos con el tomate, el pepino y la cebolla. Adereza con el aceite de oliva, el jugo de limón, sal y pimienta al gusto. Añade perejil fresco picado si lo deseas. Mezcla bien y sirve.";
imgReceta.src = 'ensaladaGarbanzo.jpg';
imgReceta.alt = 'ensalada de garbanzo';
