...
//CREAR LISTASS
pTitulo.textContent = 'Ensalada de atún';
const ingredientesEnsaladaAtun = ['1 Lata de atún', '1/2 Cebolla', '1 Tomate', '1 Pepino', '2 Cucharadas de mayonesa', 'Sal', 'Pimienta'];
ingredientesEnsaladaAtun.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Escurre el atún y colócalo en un tazón. Corta la cebolla, el tomate y el pepino en cubos pequeños. Añade las verduras al tazón con el atún. Agrega la mayonesa y mezcla bien. Sazona con sal y pimienta al gusto.";
imgReceta.src = 'ensaladaAtun.jpg';
imgReceta.alt = 'ensalada de atún';
