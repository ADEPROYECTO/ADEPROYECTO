...
//CREAR LISTASS
pTitulo.textContent = 'Galletas de avena';
const ingredientesGalletasAvena = ['2 Tazas de avena', '1 Taza de harina', '1/2 Taza de azúcar', '1/2 Taza de azúcar moreno', '1/2 Taza de mantequilla', '1 Huevo', '1 Cucharadita de vainilla', '1/2 Cucharadita de bicarbonato de sodio', '1/2 Cucharadita de canela'];
ingredientesGalletasAvena.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Precalienta el horno a 180°C. En un tazón grande, mezcla la mantequilla con los azúcares hasta que esté cremosa. Añade el huevo y la vainilla, y mezcla bien. En otro tazón, combina la harina, la avena, el bicarbonato de sodio y la canela. Añade los ingredientes secos a la mezcla de mantequilla y mezcla bien. Forma bolas con la masa y colócalas en una bandeja para hornear. Aplana ligeramente las bolas con un tenedor. Hornea durante 10-12 minutos o hasta que estén doradas.";
imgReceta.src = 'galletasAvena.jpg';
imgReceta.alt = 'galletas de avena';
