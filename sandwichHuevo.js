...
//CREAR LISTASS
pTitulo.textContent = 'Sandwich de huevo';
const ingredientesSandwichHuevo = ['Pan de molde', 'Huevos', 'Queso', 'Jamón (opcional)'];
ingredientesSandwichHuevo.forEach(ingrediente => {
