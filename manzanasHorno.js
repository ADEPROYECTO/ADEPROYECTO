...
//CREAR LISTASS
pTitulo.textContent = 'Manzanas al horno';
const ingredientesManzanasHorno = ['4 Manzanas', '4 Cucharadas de azúcar', '1 Cucharadita de canela', '1/4 Taza de nueces picadas (opcional)', '1/4 Taza de pasas (opcional)', 'Mantequilla (opcional)'];
ingredientesManzanasHorno.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Precalienta el horno a 180°C. Lava las manzanas y quítales el corazón. Mezcla el azúcar con la canela, las nueces y las pasas. Rellena las manzanas con esta mezcla. Coloca una pequeña cantidad de mantequilla encima de cada manzana si lo deseas. Coloca las manzanas en una bandeja para hornear y hornea durante 25-30 minutos o hasta que las manzanas estén tiernas.";
imgReceta.src = 'manzanasHorno.jpg';
imgReceta.alt = 'manzanas al horno';
