...
//CREAR LISTASS
pTitulo.textContent = 'Tostada de huevo con aguacate';
const ingredientesTostada = ['Pan tostado', 'Huevo', 'Aguacate', 'Sal', 'Pimienta'];
ingredientesTostada.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Tuesta el pan. Cocina el huevo a tu gusto (frito, revuelto, etc.). Unta aguacate sobre el pan tostado. Coloca el huevo cocido encima. Espolvorea con sal y pimienta al gusto.";
imgReceta.src = 'tostadaHuevo.jpg';
imgReceta.alt = 'tostada de huevo con aguacate';
