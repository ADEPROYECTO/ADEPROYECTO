...
//CREAR LISTASS
pTitulo.textContent = 'Lentejas';
const ingredientesLentejas = ['2 Tazas de lentejas', '1 Zanahoria', '1/2 Cebolla', '1 Tomate', '2 Dientes de ajo', '1 Hoja de laurel', 'Sal', 'Pimienta', 'Agua'];
ingredientesLentejas.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Lava las lentejas y ponlas en una olla con agua. Corta la zanahoria, la cebolla y el tomate en trozos pequeños. Añade las verduras, los ajos y la hoja de laurel a la olla. Cocina a fuego medio hasta que las lentejas estén tiernas. Sazona con sal y pimienta al gusto.";
imgReceta.src = 'lentejas.jpg';
imgReceta.alt = 'lentejas';
