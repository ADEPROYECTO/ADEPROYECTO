...
//CREAR LISTASS
pTitulo.textContent = 'Arroz frito';
const ingredientesArrozFrito = ['2 Tazas de arroz cocido', '1 Zanahoria', '1/2 Cebolla', '1/2 Taza de guisantes', '2 Huevos', 'Salsa de soja'];
ingredientesArrozFrito.forEach(ingrediente => {
    const li = document.createElement('li');
    li.textContent = ingrediente;
    liIngredientes.appendChild(li);
});
pProcedimiento.textContent = "Corta la zanahoria y la cebolla en cubos pequeños. En una sartén grande, saltea la cebolla y la zanahoria hasta que estén tiernas. Añade los guisantes y cocina por unos minutos. Empuja las verduras a un lado de la sartén y añade los huevos batidos, cocinándolos hasta que estén revueltos. Agrega el arroz cocido y mezcla bien. Añade salsa de soja al gusto y cocina hasta que todo esté bien caliente.";
imgReceta.src = 'arrozFrito.jpg';
imgReceta.alt = 'arroz frito';
